...
OutputFolder = ['/cbica/projects/abcdfnets/results/SingleParcel_1by1/' subj '/'];
%%%

% resampled V of interest (group or individ - CHANGE AS FIT TO MATCH NAME)
finalUVFile=['/cbica/projects/abcdfnets/results/SingleParcel_1by1/' subj '/IndividualParcel_Final_sbj1_comp17_alphaS21_1_alphaL300_vxInfo1_ard0_eta0/final_UV.mat'];
