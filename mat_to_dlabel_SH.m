function mat_to_dlabel_SH(subj)

%%%
ProjectFolder = '/cbica/projects/abcdfnets/results';
OutputFolder = ['/cbica/projects/abcdfnets/results/SingleParcel_1by1_SH/' subj '/'];
%%%

% resampled V of interest (group or individ - CHANGE AS FIT TO MATCH NAME)
finalUVFile=['/cbica/projects/abcdfnets/results/SingleParcel_1by1_SH/' subj '/IndividualParcel_Final_sbj1_comp17_alphaS21_1_alphaL300_vxInfo1_ard0_eta0/final_UV.mat'];
...
outputfile=['/cbica/projects/abcdfnets/results/SingleParcel_1by1_SH/' subj '/' subj '_Parcel.dscalar.nii'];
